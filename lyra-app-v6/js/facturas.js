...
import {
    collection, doc, getDoc, getDocs, deleteDoc, query, orderBy, updateDoc, addDoc
...
async function obtenerConfiguracion() {
    try {
        ...
        return {
            hotelName: 'Lyra App', clientName: '', clientCIF: '', clientAddress: '', clientPhone: '', clientLogo: null,
